...
echo_and_run cd "/home/dfd/ProyRob/src/roboclaw_ros/roboclaw_node"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/dfd/ProyRob/src/roboclaw_ros/roboclaw_node/setup.py" \
     \
    build --build-base "/home/dfd/ProyRob/build/roboclaw_ros/roboclaw_node" \
    install \
    --root="${DESTDIR-/}" \
